...
export const testimonials = [
    {
        ...
        quote: "DocShare has transformed how our team collaborates on creative assets. The secure sharing and intuitive interface have made file management a breeze.",
        rating: 5
    },
    {
        name: "Michael Chen",
        ...
        quote: "As a freelancer, I need to share large design files with clients securely. DocShare's simple interface and reasonable pricing make it my go-to solution.",
        rating: 5
    },
    {
        name: "Priya Sharma",
        ...
        quote: "Managing project files across multiple teams used to be a nightmare until we found DocShare. Now everything is organized and accessible exactly when we need it.",
        rating: 4
    }
];
